...
$(document).ready(function() {
	...
	Object.keys(state_info).forEach(function(key) {
		...
		var lat = value.lat
		var lon = value.lng
		var url = 'https://api.darksky.net/forecast/ec8f14a1a8d7a067da133b399a0fec6e/'+lat+','+lon;
		$.ajax({url:url, dataType:"jsonp"}).then(function(data) { 
			var curr = data.currently;
			var temp = curr.temperature;
			console.log(value.capital,temp);
